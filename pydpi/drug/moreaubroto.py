...
def CalculateMoreauBrotoAutoMass(mol):
    ...
    for i in range(8):
        res['ATSm' + str(i + 1)] = _CalculateMoreauBrotoAutocorrelation(mol,
...
def CalculateMoreauBrotoAutoVolume(mol):
    ...
    for i in range(8):
        res['ATSv' + str(i + 1)] = _CalculateMoreauBrotoAutocorrelation(mol,
...
def CalculateMoreauBrotoAutoElectronegativity(mol):
    ...
    for i in range(8):
        res['ATSe' + str(i + 1)] = _CalculateMoreauBrotoAutocorrelation(mol,
...
def CalculateMoreauBrotoAutoPolarizability(mol):
    ...
    for i in range(8):
        res['ATSp' + str(i + 1)] = _CalculateMoreauBrotoAutocorrelation(mol,
